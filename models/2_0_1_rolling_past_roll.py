...
df_timeseries["reverse_date"] = pd.to_datetime(df_timeseries.reverse_date, format= "%Y%m%d" )
df_timeseries["reverse_date"] = df_timeseries["reverse_date"].dt.date
df_timeseries["fullVisitorId"] = df_timeseries["fullVisitorId"].astype(str)


df_timeseries["id_reversedate"] = df_timeseries.fullVisitorId.astype(str) + df_timeseries.reverse_date.astype(str) 
df_timeseries["date"] = df_timeseries.id_reversedate.map(reverseddateid_to_ordinaldate)
